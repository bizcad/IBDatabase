    ...
    public class EClientSocket
    {
        ...
        */
        ...
        public void cancelMktData(int tickerId)
        {
            ...
            Console.WriteLine($"Cancelling Market Data {tickerId}");
        }
         ...
         * It is possible to specify a timezone optionally. The resulting bars will be returned in EWrapper::historicalData
